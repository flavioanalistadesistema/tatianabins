		...
		<p>
			...
			<div class="col-lg-12 col-md-12">
				...
				<iframe src="https://snapwidget.com/embed/385962" class="snapwidget-widget" allowTransparency="true" frameborder="0" scrolling="no" style="border:none; overflow:hidden; width:100%; ">
					...
					<center><a href="#" class="btn btn-social btn-instagram">
							<i class="fa fa-instagram"></i>Instagram teste
						</a></center>
					<!-- LightWidget WIDGET -->
				...
				<div class="col-lg-4 col-md-4">
					...
					<a data-pin-do="embedUser" data-pin-board-width="400" data-pin-scale-height="225px" data-pin-scale-width="80" href="https://br.pinterest.com/tatianabinns/"></a>
